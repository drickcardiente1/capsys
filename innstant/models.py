...
class TenantInfo(models.Model):
    ...
    contact_number = models.IntegerField(default=0000000000, null=True,  blank=True,)
    guardian_name = models.CharField(max_length=200, null=True, blank=True, )
    guardian_contact_number = models.IntegerField(default=0000000000, null=True,  blank=True, )
...
class Footer(models.Model):
    ...
    Contact2 = models.IntegerField(default=0, blank=True, null=True)
    Landline = models.IntegerField(default=0, blank=True, null=True)
